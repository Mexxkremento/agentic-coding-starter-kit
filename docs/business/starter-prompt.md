...
Ich möchte zur Verbesserung des Kundenservice einen ChatBot  programmieren und an B2C verkaufen. Zunächst möchte ich dem potentiellen Kunden einen Demo Chatbot auf einer Universal Demo Seite zum testen anbieten. Hosting über Vercel. Im Frontend soll sich der Chatbot über klick auf eine Bubble unten rechts auf der Webseite öffnen und zunächst einen Datenschutzhinweis mit Link auf Datenschutzerklärung öffnen und die Zustimmung des Nutzers durch Bestätigungs Klick einholen. Weiterhin soll die erste Message des Chatbots um Verständnis bitten, dass es sich um einen digitalen Kundenservice-Assistenten handelt, der noch jeden Tag dazu lernt. Der Chatbot soll "Baumi" heißen. Neben  üblichen Kundenfragen, soll der Bot Fragen zu Produkten in einem Online-Shop beantworten und in den Antworten dem Nutzer einen produkt spezifischen Link anbieten, um die conversionrate zu erhöhen. Im Backend muss die Möglichkeit bestehen eine .json datei in einen vector store hochzuladen, aus der der chatbot seine Informationen bezieht. Mache mir einen Umsetzungsvorschlag.
